...
'''
    This file is for inferencing the model on Raspberry Pi with OpenVINO
'''
...
model_xml_CPU = 'FER2013_EdgeCNN/torch_model.xml'
model_bin_CPU = 'FER2013_EdgeCNN/torch_model.bin'
